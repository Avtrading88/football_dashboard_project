...
def show_predictions_page(filtered_df):
    ...
    st.warning(
        "The predictive models are exploratory and trained on the available season data. "
        "They are intended to demonstrate machine learning workflow and interactive football analytics, "
        "not to provide professional betting or scouting predictions."
    )
    ...
    with tab1:
        ...
        if goal_predictions is None:
            ...
            st.markdown("#### Estimated Goals Table")
